...
cache_dir = os.path.join(os.path.expanduser('~'), '.myPackage')


def get_file(url, file_name=None):
    """
    Download a file from the 'url' if it's not in the cache.

    The file at the 'url' is downloaded to the '~/.myPackage'.

    Parameter
    ---------
    url (str): URL of the file.
    file_name (str): Name of the file. It 'None' is specified the original file name is used.
